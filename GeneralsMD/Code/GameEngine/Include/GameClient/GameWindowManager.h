...
public:
	...
	// GeneralsX @feature Codex 13/09/2026 XR uses composed presentation for modal dialogs.
	Bool hasModalWindow() const { return m_modalHead != nullptr; }
	...
	// GeneralsX @feature Codex 14/09/2026 Read-only, includes disabled/static hints.
	GameWindow *getWindowForTooltipAt(Int x, Int y);
