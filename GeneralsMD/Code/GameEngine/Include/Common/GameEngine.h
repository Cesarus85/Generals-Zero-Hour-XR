...
public:
	...
	// GeneralsX @feature XR port Phase 1.0 - one main-loop iteration for an
	// external frame driver (XR). Returns FALSE once the game wants to quit.
	virtual Bool executeSingleFrame();
