...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
// GeneralsX @feature Codex 14/09/2026 Read-only visibility for XR full-canvas
// dialogs, including the native slide-in/out animation lifetime.
Bool IsDiplomacyVisible()
{
	return theWindow && !theWindow->winIsHidden();
}
