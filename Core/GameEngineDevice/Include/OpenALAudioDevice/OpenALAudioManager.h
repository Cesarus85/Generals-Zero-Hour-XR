...
public:
	...
	virtual UnsignedInt getNumAvailable2DSamples(void) const;
	virtual UnsignedInt getNumAvailable3DSamples(void) const;
...
protected:
	...
	void releaseSampleBuffer(PlayingAudio *sample);
