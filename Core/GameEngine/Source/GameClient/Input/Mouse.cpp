...
Mouse::Mouse()
{
	...
	m_dragTolerance3D = 0;
	m_dragToleranceMS = 0;
	m_sawRealMouse = FALSE;
	m_touchSelecting = FALSE;
...
// ------------------------------------------------------------------------------------------------
void Mouse::markRealMouseSeen()
{
	m_sawRealMouse = TRUE;
}

// ------------------------------------------------------------------------------------------------
Bool Mouse::sawRealMouse() const
{
	return m_sawRealMouse;
}

// ------------------------------------------------------------------------------------------------
void Mouse::setTouchSelecting( Bool selecting )
{
	m_touchSelecting = selecting;
}

// ------------------------------------------------------------------------------------------------
Bool Mouse::touchSelecting() const
{
	return m_touchSelecting;
}
