...
// GeneralsX @bugfix Codex 14/09/2026 The science overlay is not modal and
// does not change the command-bar context. Inspect its actual visibility.
Bool ControlBar::isPurchaseScienceVisible() const
{
	return m_contextParent[CP_PURCHASE_SCIENCE] &&
		!m_contextParent[CP_PURCHASE_SCIENCE]->winIsHidden();
}
