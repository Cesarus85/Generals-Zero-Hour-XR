...
// GeneralsX @feature Codex 13/09/2026 A detached XR panel already owns UI
// hit testing. Only that caller bypasses legacy screen-space UI occlusion.
Bool CanSelectDrawable( const Drawable *draw, Bool dragSelecting, Bool ignoreScreenUI = FALSE );
