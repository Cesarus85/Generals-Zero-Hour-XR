...
public:
	...
	// GeneralsX @bugfix Codex 14/09/2026 Full-canvas presentation query.
...
public:
	...
	// GeneralsX @feature Codex 14/09/2026 Read-only native tooltip fields for XR.
	UnsignedInt describeCommand(const CommandButton *, UnicodeString &name, UnicodeString &cost, UnicodeString &description) const;
