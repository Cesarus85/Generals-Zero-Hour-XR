...
for name in xrIssueGuard xrIssueMovement xrUpdateBookmarkSession XrGameBoot_FormationActive XrGameBoot_TacticalReason XrGameBoot_BookmarkKnown XrGameBoot_Bookmark XrGameBoot_CancelTarget XrGameBoot_TacticalAction; do
