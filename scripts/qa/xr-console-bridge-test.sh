...
for name in xrCancelTactics XrGameBoot_TacticalGroup XrGameBoot_GroupSize XrGameBoot_Communicator XrGameBoot_SetLanguage XrGameBoot_LanguageStatus XrGameBoot_ViewBase; do
  sed -n -E "/^(static )?(void|int|bool|std::string) ${name}\(/,/^}/p" GeneralsMD/Code/Main/XrGameBoot.cpp
